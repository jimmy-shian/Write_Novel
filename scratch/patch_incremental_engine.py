...
# Use relative path relative to this script's directory to avoid encoding issues with Chinese folder names
script_dir = os.path.dirname(os.path.abspath(__file__))
filepath = os.path.join(script_dir, "..", "incremental_patch_engine.py")
